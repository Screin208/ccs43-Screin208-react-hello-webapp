...
function Card2({ data3 }) {
  ...
  return (
    <div className="card" style={{ minWidth: "18rem" }}>
      <div>
        <img
          src={`https://starwars-visualguide.com/assets/img/planets/${data3.uid}.jpg`}
      ...
      <div className="card-body">
        ...
        <p className="card-text m-1 p-1">
          Population:{data3.properties.population}
        </p>
        <p className="card-text  m-1 p-1">Terrain:{data3.properties.terrain}</p>
        <div className="d-flex ">
          <button
            className="btn border border-primary lernmore"
            onClick={() => {
          ...
          <button
            className={`border border-warning m-1 fa-heart heart ${
              actions.boton(data3.properties.name) ? "fa-solid" : "fa-regular"
            }`}
            onClick={() => {
              actions.agregado(data3.properties.name);
            }}
          >
            {" "}
          </button>
